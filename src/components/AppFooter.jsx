...
const AppFooter = () => {
  ...
  return (
    <footer className="w-full max-w-full overflow-x-hidden border-t border-slate-200 bg-white select-none transition-colors duration-300 dark:bg-slate-900 dark:border-slate-800 shrink-0">
